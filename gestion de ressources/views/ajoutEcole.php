                            ...
                            <div class="col-lg-6=12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="ajoutAuteur.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                            ...
                                                            <div class="col-12 col-md-9">
                                                                <input type="text" id="prix" name="prix" placeholder="prix" class="form-control" required>
