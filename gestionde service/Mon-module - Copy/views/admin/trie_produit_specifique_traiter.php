...
if ($_POST['data'] === 'titre')
    $listeProduit_sp=$recl->afficher_Produit_specifique_titre_traiter();
else if ($_POST['data'] === 'auteur')
    $listeProduit_sp=$recl->afficher_Produit_specifique_auteur_traiter();
else
    $listeProduit_sp=$recl->afficher_Produit_specifique_categorie_traiter();
?>
