								...
								<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
									<div class="panel-body no-padding">
										...
										<div class="payment-met">
												...
												<ul class="form-list">
													<li class="control">
														<input type="radio" class="radio" name="payment" id="form_livraison" value="Par Poste">
                                                        <label for="form_livraison">Livraison Par Poste </label>
													</li>
													<li class="control">
														<input type="radio" class="radio" name="payment" id="form_livraison1" value="FedEx">
														<label for="form_livraison">Livraison FedEx </label>
													</li>
                                                    <li class="control">
                                                        <input type="radio" class="radio" name="payment" id="form_livraison2" value="Hexa">
