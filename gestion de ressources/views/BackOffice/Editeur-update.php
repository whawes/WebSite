                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <?php  
                                                    $list= $editeur->recupererEditeurParId($_GET['id']);
                                        ?>
                                          <?php foreach($list as $row): ?>
                                        <form action="modifierEditeur.php?id=<?php echo $_GET['id'] ?>" method="post">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                        <input name="nom" value="<?php echo $row['nomMaison']?>" type="text" class="form-control" placeholder="Nom">
                                                    </div>
                                                       

                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input name="info" type="text" value="<?php echo $row['informations']?>"class="form-control" placeholder=Informations">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input name="livres" type="text"value="<?php echo $row['livres']?>" class="form-control" placeholder="Livres">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
                                                        <input name="mail" type="text" value="<?php echo $row['mail']?>" class="form-control" placeholder="Mail">
                                                    </div>
                                               >
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        ...
                                                        <input name="telephone" type="text" value="<?php echo $row['telephone']?>" class="form-control" placeholder="Telephone">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                        <input name="adresse" type="text" value="<?php echo $row['adresse']?>" class="form-control" placeholder="Addresse">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <input type="submit" value ="enregister" class="btn btn-ctl-bt waves-effect waves-light" >



                                                    <button
                                                    <a href='Editeur-update.php' class='btn btn-ctl-bt waves-effect waves-light'><span >Annuler</span></a> </button>
