                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="Editeur-ajout.php">Add Product</a>
                            </div>
...
/*  if($result = mysqli_query($link, $sql)){
 ...
 foreach($liste as $row){                                     echo "<tr>";
                                        echo "<td>" . $row['nomMaison'] . "</td>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='Editeur-edit.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
                                            echo "<a href='Editeur-update.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                            echo "<a href='supprimerEditeur.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                   }
