    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" width="25px" height="25px" src="img/logo/logo.png" alt="" /></a>
                <strong><img width="25px" height="25px" src="img/logo/logosn.png" alt="" /></strong>
            </div>
