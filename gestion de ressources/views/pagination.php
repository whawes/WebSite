<?php 
$connect = mysqli_connect("localhost", "root", "", "projet-1");
$record_per_page = 5;
$page = '';
if(isset($_GET["page"]))
{
...
$query = "SELECT * FROM editeur order by id DESC LIMIT $start_from, $record_per_page";
...
<html>
 ...
 <body>
  <br /><br />
  <div class="container">
   <h3 align="center">Liste editeur</h3><br />
   <div class="table-responsive">
    ...
    <br />
    <?php
    $page_query = "SELECT * FROM editeur ORDER BY id DESC";
