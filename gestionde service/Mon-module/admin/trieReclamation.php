...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="mystylead.css">
    <!-- favicon
        ============================================ -->
                                    ...
                                    <div class="header-right-info">
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                            ...
                                            <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="icon nalika-alarm" aria-hidden="true"></i><span class="indicator-nt"></span></a>
                                                ...
                                                if(notif()>0){
                                                    ?>
                                                    <span class="badge badge-light"><?php echo notif(); ?></span>
                                                    <?php
                                                }
                                                        ...
                                                        <li>
                                                            <a href="afficherReclamation.php">
                                                                ...
                                                                <div class="notification-content">
                                                                    <h2> Reclamation</h2>
                                                                    <p>nouvelle reclamation de <?php echo notif_con(); ?> </p>                                                                    </div>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="breadcomb-wp">
                                        ...
                                        <div class="breadcomb-ctn">
                                            ...
                                            <p>Bienvenu <span class="bread-ntd">C.T.L </span></p>
                                            <form method="POST" action="supprimerReclamation.php" class="sup_mod">
                                                ...
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control"re placeholder="nom..." name="nom">
                                                    </div>

                                                    <
                                                    <input type="submit" name="suprimer" value="suprimer" class="supprimer">
...
<thead> <!-- En-tête du tableau -->
    ...
    $listeReclamation=$recl->trieReclamtion();
    ...
    <div class="rec_text">
        <table border="5">
            ...
            <tr>
                ...
                <td><a href="trait.php?id=<?php echo $row['id']; ?>"><input type="button" value="traiter"></a></td>
                <td><a href="supprimerReclamation.php?id=<?php echo $row['id']; ?>"><input type="button" value="supprimer"></a></td>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="footer-copy-right">
                        <p>It Crowd © 2019 <a href="https://colorlib.com/wp/templates/">Colorlib</a> All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
