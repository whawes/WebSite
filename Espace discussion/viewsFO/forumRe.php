...
$downvote = "downvote";
$value = 0;
setcookie($upvote, $value, time() + (86400 * 30), "/");*/
//setcookie($downvote, $value, time() + (86400 * 30), "/");
                        ...
                        <div class="shop-tab-area">
                            <div class="shop-tab-list">
                                        ...
                                        <ul>
                                            <li>
                                                <form method="GET" action="forumRe.php" class="title-5">
                                                    <input name="reche" type="text" placeholder="Enter your tags" required>
                                ...
                                <div class="shop-tab-pill pull-right">
                                    <ul>
                                        <form action="" method="GET" class="newww">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="menu1">
                                    <?php  $np=$_GET['reche']; require 'AfficherSujetsRe.php';?>
                                </div>
                            </div>
                        </div>
                    </div>
