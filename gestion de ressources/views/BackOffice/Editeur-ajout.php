            ...
            <div class="single-pro-review-area">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <form action="ajoutEditeur.php" method="post">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input name="info" type="text" class="form-control" placeholder=Informations">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input name="livres" type="text" class="form-control" placeholder="Livres">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                        <input name="adresse" type="text" class="form-control" placeholder="Addresse">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <input type="submit" value ="save" class="btn btn-ctl-bt waves-effect waves-light" >
