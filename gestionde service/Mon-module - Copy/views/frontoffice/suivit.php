...
<table>
        ...
        <td>Votre Message de Reclamation est :<br><?PHP echo $recl->afficherReclamtion_a_modifier($a); ?>
                <textarea placeholder="text" name="text_modifier" value="<?PHP echo $recl->afficherReclamtion_a_modifier($a); ?>"></textarea>
                 <input type="submit" name="modifier" value="modifier" class="btn btn-default">
            <a href="contact.html" class="btn btn-default" title="reclamations">
                <span >
                    Retour
                </span>
            </a>
