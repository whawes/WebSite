                            ...
                            <div class="col-lg-6=12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="ajoutediteur.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <textarea name="info" id="info" rows="9" placeholder="Description ..." class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" id="livres" name="livres" placeholder="Livres" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row form-group">
                                                            ...
                                                            <div class="col-12 col-md-9">
                                                                <input type="email" id="mail" name="mail" placeholder="email" class="form-control">
