...
<html class="no-js" lang="">
    ...
    <body>
       ...
       <div class="header-area">
        ...
        <div class="breadcrumbs-area-ecole">

			<div class="container">
				<div class="row">
					<div class="col-md-12">
					    <div class="breadcrumbs">
					       <h2>Connectez-Vous à votre Espace école !</h2> 
                    ...
                    <div class="col-md-6 col-sm-6">
                       <form action="connexion.php" class="create-account-form" method="post" >
                            <h2 class="heading-title">
                                Etes-Vous directeur d'une école primaire?  
                            </h2>
                            <p class="form-row">
                                <input name="mail" type="email" placeholder="Votre email" required>
                            </p>
                            <p class="form-row">
                                <input name="mdp" type="password" placeholder="Mot de passe" required>
                            </p>
                            <p class="lost-password form-group">
                                <a href="#" rel="nofollow">mot de passe oublié?</a>
                            </p> 
                            <div class="submit">					
        ...
        <!-- Loging Area End -->
          <div class="container" >
                        ...
                        <h2>L' Espace Ecole </h2>
                        <h3>vous permet de :</h3>
                        <table class="table-admin" border="0" cellpadding="50" cellspacing="50" width="100%" >
                                                            <tr>
                                    <td>
                                        <div><img src="http://medias.dunod.com/document/campagne/Page_EES/picto-commander.png" walt=""></div>
                                        commander<br>
                                        vos spécimens</td>
                                    <td>
                                        <div><img src="http://medias.dunod.com/document/campagne/Page_EES/picto-Evaluer.png" walt=""></div>
                                        évaluer<br>
                                        une nouveauté</td>
                                    <td>
                                        <div><img src="http://medias.dunod.com/document/campagne/Page_EES/picto-Avis.png" walt=""></div>
                                        Signaler<br>
                                        une prescription</td>
                                    <td>
                                        <div><img src="http://medias.dunod.com/document/campagne/Page_EES/picto-Contact.png" walt=""></div>
                                        nous<br>
                                        contacter</td>
                                    <td>
                                        <div><img src="http://medias.dunod.com/document/campagne/Page_EES/picto-Event.png" walt=""></div>
                                        annoncer vos<br>
                                        événements</td>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-8">
                            <div class="footer-left">
                                ...
                                <p>N'hésitez pas à nous contacter ou nous joindre pour plus d'information. </p>
                        ...
                        <div class="col-md-3 col-sm-8">
                            <div class="single-footer footer-newsletter">
                                ...
                                <p>Suivez-Nous pour être à jour!</p>
                                <form action="subscribe.html" method="post">
                                    <button class="btn btn-search btn-small" type="submit">Inscrivez-Vous</button>
                                </form>
                        ...
                        <div class="col-md-2 col-sm-4 visible-sm">
                            <div class="single-footer">
                                <h2 class="footer-title">Catalogue</h2>
                                <ul class="footer-list">
                                    <li><a href="#">Cataloge1</a></li>
                                    <li><a href="#">Cataloge2</a></li>
                                    <li><a href="#">Cataloge3</a></li>
                            ...
                            <div class="modal-product">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="quick-desc">
                                        CENTRE TUNISIEN DES LIVRES est spécialisée dans l'édition et la distribution de livres ainsi que l'organisation de foires nationales. 
                                    </div>
        ...
        <?php 
        if(isset($_GET['id']))
            echo "<script>alert(\"Vérifiez vos login et mot de passe! \\n Merci\")</script>"
        ?>
