...
$client1=new Clients() ;
$Tabclient=$client1->afficherclient();
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <td class="text-right"><?php echo $row['Datenaissance']?></td>

                                                <td class="text-right"><?php echo $row['Email']?></td>
                                                <td class="text-right"><?php echo $row['Motdepasse']?></td>
                                                <td class="text-right"><?php echo $row['NumTel']?></td>
                                                <td class="text-right"><?php echo $row['Adresse']?></td>
                                                <td class="text-right"><?php echo $row['Ville']?></td>
                                                <td class="text-right"><?php echo $row['CodePostale']?></td>
