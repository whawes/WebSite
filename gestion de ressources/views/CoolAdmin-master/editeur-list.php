                        ...
                        <li>
                         ...
                         <li class="active">
                            <a href="editeur-list.php">
                                <i class="fas fa-table"></i>Table editeur</a>
                        </li>
                        <li>
                            <a href="form.html">
                                <i class="far fa-check-square"></i>Forms</a>
...
mail($to,$sujet,$texte,$header);
                                        ...
                                        <form  action="" method="post">
                                        	<input type="submit" name="submitll" value="envoyer">
                                        </form>
                                      ></option>
...
mail($to,$sujet,$texte,$header);
                                    ...
                                    <div class="table-data__tool-right">
                                        <a href="editeurajout.php" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i>Ajouter Editeur</a>
                                        <div class="rs-select2--dark rs-select2--sm rs-select2--dark2">
                                            <select id="sort" onchange="sort()" class="js-select2" name="type">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table id="tab233" class="table table-data2">
                                    <?php
